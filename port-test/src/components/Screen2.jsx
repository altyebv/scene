...
function ChatScreen() {
    ...
    const sendMessage = async (msg) => {
        ...
        // First response
        const response1 = "I'd love to help you create an awesome portfolio , but the thing is ...";
        await typeResponse(response1);

        // Second response with shorter delay
        const response2 = "I'm just a reflection of how you think , the real question is ,Can you ?";
